...
uint8_t floppy_ribbon_is_reversed(void);
void floppy_insert(unsigned int unit, struct slot *slot);
void floppy_cancel(void);
uint8_t floppy_handle(void); /* TRUE -> re-read config file */
